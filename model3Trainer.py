...
def main():
    ...
    train_data_width = 80
    batch_size = 60
    total_number_of_iteration = 1000
    ...
    life = tfh.Life(
        tfh.NeuralNetwork(
            layers=[
                ...
                tfh.ConvLayer(kernel_width=5, depth_out=30, depth_in=3, padding=False),
                tfh.ConvLayer(kernel_width=5, depth_out=20, padding=False),
